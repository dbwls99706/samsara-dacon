...
## 최신 (2026-05-26, 기획서 마감일, 7회차) — 첫 사이클 입력 hint (P4 가드) ⌨
...
| 우선순위 | 항목 | 마감 |
|---|---|---|
| 🔴 HIGH | **오늘 10:00 KST DACON 기획서 PDF 업로드** (`docs/06_proposal_outline.pdf`) | **2026-05-26 10:00** |
| HIGH | Vercel 첫 배포 — `npx vercel` 사용자 로그인 + 배포 | 6/4 |
| HIGH | 시연 영상 첫 5초 컷 결정 (4회차 5 후보 참조) | 6/6 |
| MEDIUM | GitHub origin push (repo 명 권장 `samsara-dacon`) | 6/4 |
